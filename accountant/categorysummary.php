...
<head>
    ...
    <title>Category Summary | <?php echo $PrimaryName.' '.$SecondaryName; ?></title>
    <!-- Bootstrap Core CSS -->
...
newWin.close();
    ...
    $("body").on("click","#loadallincprintbtn", function(){
        ...
        var institution = "<?php echo $InstitutionID; ?>";
                    ...
                    $.ajax({
                                type : 'post',
                                url : '../controller/scripts/accountant/loadallcatreport.php', //Here you will fetch records 
                                data : 'institution='+institution+'&catsumtype='+catsumtype+'&catsumsession='+catsumsession+'&catsumterm='+catsumterm+'&catsumcategory='+catsumcategory, //Pass $id
...
$(document).ready(function(){
        ...
        var institution = "<?php echo $InstitutionID; ?>";
                    ...
                    $.ajax({
                                type : 'post',
                                url : '../controller/scripts/accountant/loadcategorysummary.php', //Here you will fetch records 
...
$.ajax({
                            type : 'post',
                            url : '../controller/scripts/accountant/viewcategorysummary.php', //Here you will fetch records 
    ...
    $("body").on("click","#loadcatsumtable", function(){
        ...
        else
        {
            ...
            $("#reporttable").html("<center><i class='fa fa-spinner fa-spin'></i></center>");
                    $.ajax({
                                type : 'post',
                                url : '../controller/scripts/accountant/filterloadcatsumreporttable.php', //Here you will fetch records 
                                data : 'institution='+institution+'&catsumtype='+catsumtype+'&catsumsession='+catsumsession+'&catsumterm='+catsumterm+'&catsumcategory='+catsumcategory, //Pass $id
                                success : function(data)
                                {
