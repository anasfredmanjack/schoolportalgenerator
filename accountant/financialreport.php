...
<head>
    ...
    <title>Financial Report | <?php echo $PrimaryName.' '.$SecondaryName; ?></title>
    <!-- Bootstrap Core CSS -->
        ...
        <div class="page-wrapper" style="margin-top: -60px;">
            ...
            <div class="row page-titles no-print">
                <div class="col-md-10 align-self-center">
                    <h2 class="text-themecolor" style="color: black; font-weight: 500;">Financial Report</h2>
                </div>
...
newWin.close();
    ...
    $("body").on("click","#loadallincprintbtn", function(){
        ...
        var institution = "<?php echo $InstitutionID; ?>";
                    ...
                    $.ajax({
                                type : 'post',
                                url : '../controller/scripts/accountant/loadallfinancialreport.php', //Here you will fetch records 
...
$(document).ready(function(){
        ...
        var institution = "<?php echo $InstitutionID; ?>";
                    ...
                    $.ajax({
                                type : 'post',
                                url : '../controller/scripts/accountant/loadfinancialreport.php', //Here you will fetch records 
                                data : 'institution='+institution, //Pass $id
                                success : function(data)
                                {
...
$.ajax({
                            type : 'post',
                            url : '../controller/scripts/accountant/viewfinancialreportcontent.php', //Here you will fetch records 
    ...
    $("body").on("click","#loadincometable", function(){
        ...
        if(incometype == '0' && incomesession == '0' && categorytype =='0' && incometerm == '0' && incomeclass == '0' && incomecategory == '0' && incomesubCategory == '0' && incomestartdate == '' && incomeenddate == '')
        {
        ...
        else
        {
            ...
            $("#reporttable").html("<center><i class='fa fa-spinner fa-spin'></i></center>");
                    $.ajax({
                                type : 'post',
                                url : '../controller/scripts/accountant/filterloadfinancialreporttable.php', //Here you will fetch records 
