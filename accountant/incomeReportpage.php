...
newWin.close();
    ...
    $("body").on("click","#loadallincprintbtn", function(){
        ...
        var institution = "<?php echo $InstitutionID; ?>";
                    ...
                    $.ajax({
                                type : 'post',
                                url : '../controller/scripts/accountant/loadallincomereport.php', //Here you will fetch records 
...
$(document).ready(function(){
        ...
        var institution = "<?php echo $InstitutionID; ?>";
                    ...
                    $.ajax({
                                type : 'post',
                                url : '../controller/scripts/accountant/loadincomereporttable.php', //Here you will fetch records 
                                data : 'institution='+institution, //Pass $id
                                success : function(data)
                                {
...
$.ajax({
                            type : 'post',
                            url : '../controller/scripts/accountant/viewincomecontent.php', //Here you will fetch records 
    ...
    $("body").on("click","#loadincometable", function(){
        ...
        if(incometype == '0' && incomesession == '0' && incometerm == '0' && incomeclass == '0' && incomecategory == '0' && incomesubCategory == '0' && incomestartdate == '' && incomeenddate == '')
        {
        ...
        else
        {
            ...
            $("#reporttable").html("<center><i class='fa fa-spinner fa-spin'></i></center>");
                    $.ajax({
                                type : 'post',
                                url : '../controller/scripts/accountant/filterloadincomereporttable.php', //Here you will fetch records 
