...
<head>
    ...
    <title>Profile | <?php echo $PrimaryName.' '.$SecondaryName; ?></title>
    <!-- Bootstrap Core CSS -->
...
<body class="fix-header card-no-border logo-center">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper" style="margin-top: -80px;">
            ...
            <div class="container-fluid">
                <div id="output"></div>
                <?php  include ('../controller/scripts/schoolhead/change-profile-photo.php'); ?>
                <!-- ============================================================== -->
                <!-- Start Page Content -->
                <!-- ============================================================== -->
                <!-- Row -->
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        ...
                        <div class="card-body">
                            ...
                            <b class="text-muted">Email address </b>
                                <h6 style="color: black;"><?php echo $PersonalEmail; ?></h6>

                                <br/>

                                <b class="text-muted">Address</b>
                                <h6 style="color: black;"><?php echo $PersonalAddress; ?>, <?php echo $PersonalCity; ?> <?php echo $PersonalState; ?>, <?php echo $PersonalCountry; ?></h6>

                                <small class="text-muted p-t-30 db">Telephone</small>
                                <h6><?php echo $PersonalPhone; ?></h6>
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-7">
                        <div class="card">
                            ...
                            <input id="StaffID" type="hidden" class="form-control" value="<?php echo $UserID; ?>">
                            <input id="passworddb" type="hidden" class="form-control" value="<?php echo $passworddb; ?>">
                                ...
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    ...
                                    <div class="col-12" style="margin-top: 20px;">
                                                    ...
                                                    <input id="fname" type="text" class="form-control" value="<?php echo $PersonalNameFirst; ?>" aria-label="name">
                                                </div>
                                                <div class="col-12" style="margin-top: 20px;">
                                                    <label for="inputname" class="form-label" style="font-weight: normal; color: black;">Middle name :</label>
                                                    <input id="mname"  type="text" class="form-control" value="<?php echo $PersonalNameMiddle; ?>" aria-label="name">
                                                </div>
                                                <div class="col-12" style="margin-top: 20px;">
                                                    <label for="inputname" class="form-label" style="font-weight: normal; color: black;">Last name :</label>
                                                    <input id="sname"  type="text" class="form-control" value="<?php echo $PersonalNameLast; ?>" aria-label="name">
                                                </div>

                                                </br>
                                                <div class="col-12">
                                                    <label for="inputEmail4" class="form-label" style="font-weight: normal; color: black;">Email:</label>
                                                    <input type="email" class="form-control" value="<?php echo $PersonalEmail; ?>" id="email">
                                                </div>
                                                
                                                </br>
                                                <div class="col-12">
                                                <label for="inputnumber" class="form-label" style="font-weight: normal; color: black;">Telephone:</label>
                                                <input type="number" class="form-control" value="<?php echo $PersonalPhone; ?>" id="phone">
                                                </div>

                                                </br>
                                                <div class="col-12">
                                                <label for="inputAddress" class="form-label" style="font-weight: normal; color: black;">Address:</label>
                                                <input id="address" type="text" class="form-control" value="<?php echo $PersonalAddress; ?>" aria-label="name">
                                                </div>
    ...
    <script src="../controller/js/accountant/profile.js">  </script>
</body>
