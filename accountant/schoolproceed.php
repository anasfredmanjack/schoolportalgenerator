...
<head>
    ...
    <title>School Proceed | <?php echo $PrimaryName.' '.$SecondaryName; ?></title>
    <!-- Bootstrap Core CSS -->
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <select class="form-control chimaPrimaryBorderColor" id="classid" style="background: white; border-width: 1px; border-style: solid; margin-top:10px;">
     ...
     <script language="javascript">
        ...
        $("body").on("click","#loadviewcontent", function(){
            $("#viewmodalbody").html("<center><i class='fa fa-spinner fa-spin'></i></center>");
                        ...
                        var sessionselected = $(this).data("session");
                        var institution = "<?php echo $InstitutionID; ?>";
                        var session = $("#session").val();
                        var term = $("#term").val();
                        var filterclassid = $("#classid").val();
                    ...
                    $.ajax({
                            type : 'post',
                            url : '../controller/scripts/accountant/viewschoolproceed.php', //Here you will fetch records 
                            data : 'institution='+institution+'&session='+session+'&term='+term+'&classid='+classid+'&filterclassid='+filterclassid+'&sessionselected='+sessionselected, //Pass $id
        ...
        $("body").on("click","#loadallincprintbtn", function(){
            $("#printallcontentbody").html("<center><i class='fa fa-spinner fa-spin'></i></center>");
                ...
                var classid = $("#classid").val();
                    ...
                    $.ajax({
                                type : 'post',
                                url : '../controller/scripts/accountant/loadallschoolproceed.php', //Here you will fetch records 
                                data : 'institution='+institution+'&session='+session+'&term='+term+'&classid='+classid, //Pass $id
                                success : function(data)
                                {
    ...
    if(session == '0' && term == '0' && classid == '0')
        ...
        else
        {
            ...
            $("#reporttable").html("<center><i class='fa fa-spinner fa-spin'></i></center>");
                    $.ajax({
                                type : 'post',
                                url : '../controller/scripts/accountant/filterloadschoolproceed.php', //Here you will fetch records 
                                data : 'institution='+institution+'&session='+session+'&term='+term+'&classid='+classid, //Pass $id
                                success : function(data)
                                {
...
$(document).ready(function(){
        ...
        var institution = "<?php echo $InstitutionID; ?>";
                    ...
                    $.ajax({
                                type : 'post',
                                url : '../controller/scripts/accountant/loadschoolproceed.php', //Here you will fetch records 
