<?php  
include ('../controller/session/session-checker-schoolhead.php');
...
html body blockquote {
    border-left: 5px solid <?php echo $PrimaryColor; ?>;
...
.custom-select {
    background: url(../../library/images/custom-select.png) right 0.75rem center no-repeat
}
...
.blue-dark-theme {
    background: #263238;
    background: -moz-linear-gradient(left, #263238 0%, #263238 23%, <?php echo $PrimaryColor; ?> 23%, <?php echo $PrimaryColor; ?> 99%);
    background: -webkit-linear-gradient(left, #263238 0%, #263238 23%, <?php echo $PrimaryColor; ?> 23%, <?php echo $PrimaryColor; ?> 99%);
    background: -webkit-gradient(linear, left top, right top, from(#263238), color-stop(23%, #263238), color-stop(23%, <?php echo $PrimaryColor; ?>), color-stop(99%, <?php echo $PrimaryColor; ?>));
    background: -o-linear-gradient(left, #263238 0%, #263238 23%, <?php echo $PrimaryColor; ?> 23%, <?php echo $PrimaryColor; ?> 99%);
    background: linear-gradient(to right, #263238 0%, #263238 23%, <?php echo $PrimaryColor; ?> 23%, <?php echo $PrimaryColor; ?> 99%)
}
...
.form-material .form-control, .form-material .form-control.focus, .form-material .form-control:focus {
    background-image: -webkit-gradient(linear, left top, left bottom, from(<?php echo $PrimaryColor; ?>), to(<?php echo $PrimaryColor; ?>)), -webkit-gradient(linear, left top, left bottom, from(rgba(120, 130, 140, 0.13)), to(rgba(120, 130, 140, 0.13)));
    background-image: -webkit-linear-gradient(<?php echo $PrimaryColor; ?>, <?php echo $PrimaryColor; ?>), -webkit-linear-gradient(rgba(120, 130, 140, 0.13), rgba(120, 130, 140, 0.13));
    background-image: -o-linear-gradient(<?php echo $PrimaryColor; ?>, <?php echo $PrimaryColor; ?>), -o-linear-gradient(rgba(120, 130, 140, 0.13), rgba(120, 130, 140, 0.13));
    background-image: linear-gradient(<?php echo $PrimaryColor; ?>, <?php echo $PrimaryColor; ?>), linear-gradient(rgba(120, 130, 140, 0.13), rgba(120, 130, 140, 0.13));
    border: 0 none;
    border-radius: 0;
    -webkit-box-shadow: none;
    box-shadow: none;
...
.dataTables_length select {
    border: 0;
    background-image: -webkit-gradient(linear, left top, left bottom, from(<?php echo $PrimaryColor; ?>), to(<?php echo $PrimaryColor; ?>)), -webkit-gradient(linear, left top, left bottom, from(#b1b8bb), to(#b1b8bb));
    background-image: -webkit-linear-gradient(<?php echo $PrimaryColor; ?>, <?php echo $PrimaryColor; ?>), -webkit-linear-gradient(#b1b8bb, #b1b8bb);
    background-image: -o-linear-gradient(<?php echo $PrimaryColor; ?>, <?php echo $PrimaryColor; ?>), -o-linear-gradient(#b1b8bb, #b1b8bb);
    background-image: linear-gradient(<?php echo $PrimaryColor; ?>, <?php echo $PrimaryColor; ?>), linear-gradient(#b1b8bb, #b1b8bb);
    background-size: 0 2px, 100% 1px;
    background-repeat: no-repeat;
    background-position: center bottom, center calc(100% - 1px);
    background-color: transparent;
...
.tooltip-content2:after {
    ...
    width: 30px;
    height: 20px;
    background: url(../../library/images/tooltip/tooltip1.svg) no-repeat center center;
    background-size: 100%
}

.tooltip-content3 {
    position: absolute;
    background: url(../../library/images/tooltip/shape1.svg) no-repeat center bottom;
...
.tooltip-text3 {
    border-bottom: 10px solid <?php echo $PrimaryColor; ?>;
    overflow: hidden;
...
.error-box {
    height: 100%;
    position: fixed;
    background: url(../../library/images/background/error-bg.jpg) no-repeat center center #fff;
    width: 100%
}
...
.has-success .form-control-success {
    background-image: url(../../library/images/icon/success.svg)
}
...
.has-warning .form-control-warning {
    background-image: url(../../library/images/icon/warning.svg)
}
...
.has-danger .form-control-danger {
    background-image: url(../../library/images/icon/danger.svg)
}
...
.chimaPrimaryBorderColor{
    border-color: <?php echo $PrimaryColor; ?>;
}
.chiPrimaryCreateBtn{
    background-color:<?php echo $PrimaryColor; ?>;
    border:<?php echo $PrimaryColor; ?>;
    border-radius: 30px;
    font-size: 13px;
    color: white;
    margin-left: 10px;
...
.container-motto img p img {
    display: inline-block;
    margin-left: 200px;
}

.container-motto .motto {
    color: darkorange; 
    font-weight: bold; 
    font-size: 20px;
    margin-left: 200px;
