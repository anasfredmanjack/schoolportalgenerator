<nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header" id="sideBarColor" style="height: 60px;">
                    <a class="navbar-brand" href="index.php">
                        ...
                        <!-- Logo text --><span>
                         <!-- dark Logo text -->
                         <img src="../img/logo/<?php echo $Logo; ?>" width="50" style="margin-top: 10px;" alt="homepage" class="dark-logo" />
                         <!-- Light Logo text -->    
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" ><img src="../img/profile/<?php echo $userPicture; ?>" style="height: 30px; width: 30px;" alt="user" class="profile-pic"  /><b style="color: white;"> <?php echo $PrimaryName; ?></b></a>
                            <div class="dropdown-menu dropdown-menu-right scale-up">
                                <ul class="dropdown-user">
                                    ...
                                    <li><a href="../controller/login/logout_institution.php"><i class="fa fa-power-off"></i> Logout</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
