                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.php">
                        <!-- Logo icon --><b>
                            ...
                            <!-- Dark Logo icon -->
                            <img src="../img/logo/<?php echo $Logo; ?>" width="30"  class="dark-logo" />
                            <!-- Light Logo icon -->
                            <img src="../img/logo/<?php echo $Logo; ?>" width="30"class="light-logo" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right scale-up">
                                <ul class="dropdown-user">
                                    ...
                                    <li><a href="../controller/login/logout_owner.php"><i class="fa fa-power-off"></i> Logout</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
