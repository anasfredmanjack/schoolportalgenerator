...
<head>
    ...
    <title>Audit Trail | <?php echo $fullname; ?></title>
    <!-- Bootstrap Core CSS -->
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-10 align-self-center">
                    <h2 class="text-themecolor" style="color: black; font-weight: 500;">Audit Trail</h2>
                </div>
        ...
        $("body").on("click","#loadincometable", function(){
            ...
            var UserID = "<?php echo $UserID; ?>";
                ...
                else
                {
                    ...
                    $.ajax({
                                        type : 'post',
                                        url : '../controller/scripts/owner/filteraudittrail.php', //Here you will fetch records 
                                        data : 'institution='+institution+'&incomestartdate='+incomestartdate+'&incomeenddate='+incomeenddate+'&UserID='+UserID, //Pass $id
...
$("body").on("click","#loadallincprintbtn", function(){
            ...
            $.ajax({
                                        type : 'post',
                                        url : '../controller/scripts/owner/loadallaudittrail.php', //Here you will fetch records 
                                        data : 'institution='+institution+'&incomestartdate='+incomestartdate+'&incomeenddate='+incomeenddate+'&UserID='+UserID, //Pass $id
                                        success : function(data)
                                        {
    ...
    $(document).ready(function(){
            ...
            var UserID = "<?php echo $UserID; ?>";
                        ...
                        $.ajax({
                                    type : 'post',
                                    url : '../controller/scripts/owner/loadaudittrail.php', //Here you will fetch records 
