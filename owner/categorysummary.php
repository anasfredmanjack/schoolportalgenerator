...
<head>
    ...
    <title>Category Summary | <?php echo $fullname; ?></title>
    <!-- Bootstrap Core CSS -->
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-10 align-self-center">
                    <h2 class="text-themecolor" style="color: black; font-weight: 500;">Category Summary</h2>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="col-sm-2">
                            ...
                            <div class="col-sm-2">
                                <select class="form-control chimaPrimaryBorderColor" id="catsumsession" style="background: white; border-width: 1px; border-style: solid; margin-top:10px;">
                            ...
                            <div class="col-sm-2">
                                ...
                                <select class="form-control chimaPrimaryBorderColor" id="catsumterm" style="background: white; border-width: 1px; border-style: solid; margin-top:10px;">
                            ...
                            <div class="col-sm-2">
                                <select class="form-control chimaPrimaryBorderColor" id="catsumcategory" style="background: white; border-width: 1px; border-style: solid; margin-top:10px;">
                                    <option  value="0">Select Category</option>                
                                </select>
                            </div>
                            <div class="col-sm-2">
                                <div class="form-group">
                                    <select class="form-control chimaPrimaryBorderColor" id="catsumtype" style="background: white; border-width: 1px; border-style: solid; margin-top:10px;">
                            ...
                            <button type="button" id="loadcatsumtable" style="width:100%;" class="btn waves-effect waves-light btn-sm btn-success">
                                    Load
                                    </button>   
                        </div>
                ...
                <div class="modal fade" id="loadviewcontentmodal" tabindex="-1" role="dialog" aria-labelledby="loadviewcontentmodalLabel" aria-hidden="true">
                      <div class="modal-dialog modal-lg ">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel"><i style="color:orangered;" class="fa fa-eye"></i>Category Details</h5>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="card card-outline-info">
                                                <div class="card-header">
                                                    <h4 class="m-b-0 text-white"><i style="color:white;" class="fa fa-eye"></i>Category Details</h4>
                                                </div>
                                                <div class="card-body">
                                                    <div>
                                                    <div class="row">
                  ...
                  <div class="modal fade" id="printallcontentmodal" tabindex="-1" role="dialog" aria-labelledby="printallcontentmodalLabel" aria-hidden="true">
                      <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel"><i style="color:green;" class="fa fa-print"></i> All Category Summary</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>
                          <div class="modal-body">
                            ...
                            <div class="row">
                                        <div class="col-lg-12">
                                            <div class="card card-outline-info">
                                                <div class="card-header">
                                                    <h4 class="m-b-0 text-white"><i style="color:white;" class="fa fa-print"></i> All Category Summary</h4>
                                                </div>
...
$(document).ready(function(){
        ...
        var UserID = "<?php echo $UserID; ?>";
                    ...
                    $.ajax({
                                type : 'post',
                                url : '../controller/scripts/owner/loadcategorysummary.php', //Here you will fetch records 
...
$("#catsumcategory").html("<option>Loading</option>");

$.ajax({
                            type : 'post',
                            url : '../controller/scripts/owner/loadinstcategories.php', //Here you will fetch records 
                            data :  'filterinstitution='+filterinstitution,  //Pass $id
                            success : function(data)
                            {
                                $('#catsumcategory').html(data);//Show fetched data from database
                            }
                        }); 
...
$("body").on("click","#loadcatsumtable", function(){
        $("#loadcatsumtable").html("<center><i class='fa fa-spinner fa-spin'></i></center>");
        ...
        if(catsumtype == '0' && catsumsession == '0' && catsumterm == '0'  && catsumcategory == '0' )
        {
            ...
            $("#loadcatsumtable").html('Load');
        }
        else if(institution == '0' || institution == '1')
        {
        ...
        else
        {
            ...
            $("#reporttable").html("<center><i class='fa fa-spinner fa-spin'></i></center>");
                    $.ajax({
                                type : 'post',
                                url : '../controller/scripts/owner/filterloadcatsumreporttable.php', //Here you will fetch records 
                                data : 'institution='+institution+'&UserID='+UserID+'&catsumtype='+catsumtype+'&catsumsession='+catsumsession+'&catsumterm='+catsumterm+'&catsumcategory='+catsumcategory, //Pass $id
                                success : function(data)
                                {
...
$.ajax({
                            type : 'post',
                            url : '../controller/scripts/owner/viewcategorysummary.php', //Here you will fetch records 
                            data :  'institution='+institution+'&catsumtype='+catsumtype+'&catsumsession='+catsumsession+'&catsumterm='+catsumterm+'&catsumcategory='+catsumcategory+'&viewdata='+viewdata,  //Pass $id
                            success : function(data)
                            {
