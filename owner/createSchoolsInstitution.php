        ...
        <div class="page-wrapper" >
            ...
            <div class="row page-titles">
                <div class="col-md-10 align-self-center">
                    <h3 class="text-themecolor" style="color: black; font-weight: 400;">Create New Schools/Institutions</h3>
                </div>
                             ...
                             <div id="output"></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="motto" type="text" class="form-control">
                                    </div>

                                    <div class="form-group">
                                        <label for="exampleInputNumber">Phone Number:</label>
                                        <input id="phone" type="number" class="form-control" id="exampleInputNumber" placeholder="+000 000 000">
                                    </div>
                                    ...
                                    <div class="form-group">
                                                ...
                                                <input id="PrimaryColor" type="color" value="" class="form-control">
                                            </div>

                                            <div class="form-group">
                                                <label for="exampleInputEmail">Secondary Color:</label>
                                                <input type="color" id="SecondaryColor" value="" class="form-control">
                                            </div>

                                            <div class="form-group">
                                                <label for="exampleInputEmail">Login Title Color:</label>
                                                <input type="color" id="loginTitleColor"  value="" class="form-control">
                                            </div>
 ...
 $(document).ready(function(){
	$(".chimaRegistarSubmitBtn").click(function(){
		...
		var UserID = '<?php echo $UserID; ?>';
		 ...
		 $('.chimaRegistarSubmitBtn').html('Creating...<i class="fa fa-spinner fa-spin"></i>');	
		var dataString = '&name='+ name +  '&institutiontype='+ institutiontype + '&website='+ website + '&motto='+ motto + '&email='+ email 
        ...
        + '&UserID='+ UserID + '&country='+ country + '&state='+ state + '&city='+ city + '&town='+ town + '&address='+ address;
	                        ...
	                        $.ajax({
							type: "POST",
							url: "../controller/scripts/owner/process_add_institution.php",
							data: dataString,
							cache: false,
