        ...
        <div class="page-wrapper" >
            ...
            <div class="row page-titles">
                <div class="col-md-10 align-self-center">
                    <h3 class="text-themecolor" style="color: black; font-weight: 400;">Create Institutions Login Details</h3>
                </div>
                             ...
                             <div align="center">
                                ...
                                <form style="margin: 30px;">
                                     <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="usernameRegNum">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail">Password:</label>
                                        <input type="password" class="form-control" id="agencyPW">
                                    </div>
...
$(".chimaRegistarSubmitBtn").click(function(){
   event.preventDefault(); 
      ...
      // alert(dob + phone + email + country + state + city + town + address);
       ...
       var dataString = '&IncompleteAccountID='+ IncompleteAccountID +  '&OwnerID='+ OwnerID + '&usernameRegNum='+ usernameRegNum + '&agencyPW='+ agencyPW;
	       
                       $.ajax({
                           type: "POST",
                           url: "../controller/scripts/owner/process_complete_institution.php",
                           data: dataString,
                           cache: false,
