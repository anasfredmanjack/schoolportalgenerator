...
<head>
    ...
    <title>Financial Report Page| <?php echo $fullname; ?></title>
    <!-- Bootstrap Core CSS -->
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles no-print">
                <div class="col-md-10 align-self-center">
                    <h2 class="text-themecolor" style="color: black; font-weight: 500;">Financial Report Page</h2>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-sm-2">
                                <div class="form-group">
                                    <select class="form-control chimaPrimaryBorderColor" id="categorytype" style="background: white; border-width: 1px; border-style: solid; margin-top:10px;">
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    <select class="form-control chimaPrimaryBorderColor" id="incometype" style="background: white; border-width: 1px; border-style: solid; margin-top:10px;">
...
$("body").on("change","#filteralltransinstitutiontab", function(){
    ...
    $("body").on("click","#loadincometable", function(){
        ...
        var incomesession = $("#incomesession").val();
        var incometerm = $("#incometerm").val();
        var incomeclass = $("#incomeclass").val();
        var incomecategory = $("#incomecategory").val();
        var incomesubCategory = $("#incomesubCategory").val();
        ...
        if(incometype == '0' && incomesession == '0' && incometerm == '0' && incomeclass == '0' && incomecategory == '0' && incomesubCategory == '0' && incomestartdate == '' && incomeenddate == ''  && institution == '0' && categorytype == '0')
        {
        ...
        else
        {
            ...
            $("#reporttable").html("<center><i class='fa fa-spinner fa-spin'></i></center>");
                    $.ajax({
                                type : 'post',
                                url : '../controller/scripts/owner/filterloadfinancialreporttable.php', //Here you will fetch records 
                                data : 'institution='+institution+'&incometype='+incometype+'&incomesession='+incomesession+'&incometerm='+incometerm+'&incomeclass='+incomeclass+'&incomecategory='+incomecategory+'&incomestartdate='+incomestartdate+'&incomeenddate='+incomeenddate+'&incomesubCategory='+incomesubCategory+'&categorytype='+categorytype, //Pass $id
                                success : function(data)
                                {
...
$("body").on("click","#filteralltransbtn", function(){
    ...
    if(institution == '0')
    {
        $("#printallcontentbody").html('<div class="alert alert-warning" role="alert"><center><i class="fa fa-warning"></i> Please select Institution to filter</center></div>');
    ...
    else
    {
        $.ajax({
                                    type : 'post',
                                    url : '../controller/scripts/owner/loadallfinancialreport.php', //Here you will fetch records 
...
$.ajax({
                            type : 'post',
                            url : '../controller/scripts/owner/viewfinancialcontent.php', //Here you will fetch records 
...
$(document).ready(function(){
        ...
        var UserID = "<?php echo $UserID; ?>";
                    ...
                    $.ajax({
                                type : 'post',
                                url : '../controller/scripts/owner/loadfinancialreporttable.php', //Here you will fetch records 
