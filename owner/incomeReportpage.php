...
<head>
    ...
    <title>Income Report Page| <?php echo $fullname; ?></title>
    <!-- Bootstrap Core CSS -->
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles no-print">
                <div class="col-md-10 align-self-center">
                    <h2 class="text-themecolor" style="color: black; font-weight: 500;">Income Report</h2>
                </div>
...
$("body").on("change","#filteralltransinstitutiontab", function(){
    ...
    $("body").on("click","#loadincometable", function(){
        ...
        if(incometype == '0' && incomesession == '0' && incometerm == '0' && incomeclass == '0' && incomecategory == '0' && incomesubCategory == '0' && incomestartdate == '' && incomeenddate == ''  && institution == '0')
        {
        ...
        else
        {
            ...
            $("#reporttable").html("<center><i class='fa fa-spinner fa-spin'></i></center>");
                    $.ajax({
                                type : 'post',
                                url : '../controller/scripts/owner/filterloadincomereporttable.php', //Here you will fetch records 
                                data : 'institution='+institution+'&incometype='+incometype+'&incomesession='+incomesession+'&incometerm='+incometerm+'&incomeclass='+incomeclass+'&incomecategory='+incomecategory+'&incomestartdate='+incomestartdate+'&incomeenddate='+incomeenddate+'&incomesubCategory='+incomesubCategory, //Pass $id
                                success : function(data)
                                {
...
$("body").on("click","#filteralltransbtn", function(){
    ...
    else
    {
        $.ajax({
                                    type : 'post',
                                    url : '../controller/scripts/owner/loadallincomereport.php', //Here you will fetch records 
...
$.ajax({
                            type : 'post',
                            url : '../controller/scripts/owner/viewincomecontent.php', //Here you will fetch records 
...
$(document).ready(function(){
        ...
        var UserID = "<?php echo $UserID; ?>";
                    ...
                    $.ajax({
                                type : 'post',
                                url : '../controller/scripts/owner/loadincomereporttable.php', //Here you will fetch records 
