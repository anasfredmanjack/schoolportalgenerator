...
<head>
    ...
    <title>Income Transaction | <?php echo $fullname; ?></title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="container-fluid">
                ...
                <!-- ============================================================== -->
                    <div class="row" style="padding-top:10px;">
                        <div class="col-sm-4">
                            <select class=" form-control chimaPrimaryBorderColor" id="institution" name="location">
                                                ...
                                                <div class="col-md-2 align-self-center">
                                                    <select class=" form-control" id="subcategory">
                                                        <option value="0">Select SubCateogry</option>
                                                         <?php  
                                        					    $sqlGetsubcategory = ("SELECT * FROM category INNER JOIN subcategory ON category.categoryID = subcategory.categoryID WHERE category.configType='income' AND category.categoryType='fees'");
                                            ...
                                            <div class="row" style="padding-top:10px;">
                                                ...
                                                <div class="col-md-2 align-self-center">
                                                    <select class=" form-control" id="othersubcategory">
                                                        <option value="0">Select SubCateogry</option>
                                                         <?php  
                                        					    $sqlGetsubcategory = ("SELECT * FROM category INNER JOIN subcategory ON category.categoryID = subcategory.categoryID WHERE category.configType='income' AND category.categoryType='others'");
                                        					    $resultGetsubcategory = mysqli_query($link, $sqlGetsubcategory);
                                        					    $rowGetsubcategory = mysqli_fetch_assoc($resultGetsubcategory);
                                        					    $row_cntGetsubcategory = mysqli_num_rows($resultGetsubcategory);
    ...
    <script>
        $(document).ready(function(){
           ...
           $("body").on('change','#institution',function(){
                ...
                $('#category').html('');
                $('#category').append($('<option>').val(0).text('Loading...'));
               ...
               if(institution == 0)
               {
                   $('#body').html('<td colspan="12"><div class="alert alert-info alert-dismissible fade show" role="alert"><center>Select Institution To filter</center></div></td>');
                   $('#otherbody').html('<td colspan="12"><div class="alert alert-info alert-dismissible fade show" role="alert"><center>Select Institution To filter</center></div></td>');
                   $('#category').html('');
                    $('#category').append($('<option>').val(0).text('Select Institution First'));
               ...
               {
                   $('#body').html('<td colspan="12"><div class="alert alert-info alert-dismissible fade show" role="alert"><center>Please Filter Before Proceeding</center></div></td>');
                   $('#otherbody').html('<td colspan="12"><div class="alert alert-info alert-dismissible fade show" role="alert"><center>Please Filter Before Proceeding</center></div></td>');
                   
                    $.ajax({
                        type : 'post',
                        url: "../controller/scripts/owner/sunnygetownercategory.php",
                        data :  dataString,
                    ...
                    $.ajax({
                        type : 'post',
                        url: "../controller/scripts/owner/sunnygetownerothercategory.php",
                        data :  dataString,
                        success : function(result)
                        {
                            $('#othercategory').html(result);
                    ...
                    $.ajax({
                        type : 'post',
                        url: "../controller/scripts/owner/sunnygetownerclass.php",
                        data :  dataString,
                        success : function(result)
                        {
            ...
            $("body").on('change','#category',function(){
                ...
                $('#subcategory').html('');
                $('#subcategory').append($('<option>').val(0).text('Loading...'));
                ...
                var dataString = 'institution=' + institution + '&category=' + category;
                    ...
                    $.ajax({
                        type : 'post',
                        url: "../controller/scripts/owner/sunnygetsubcategory.php",
                        data :  dataString,
                        success : function(result)
                        {
                            ...
                            for (z = 0; z < obj1.length; z++) 
                            {
                                ...
                                $('#subcategory').append($('<option>').val(subcategoryID).text(subcategoryname));
        ...
        $("#loadfeetable").click(function(){
                ...
                var dataString = 'institution='+ institution + '&userid='+ userid + '&usertype='+ usertype + '&sdate='+ sdate + '&edate='+ edate + '&category='+ category + '&subcategory='+ subcategory + '&session='+ session + '&term='+ term + '&classid='+ classid;
                ...
                else
                {
                    ...
                    $.ajax({
                        type : 'post',
                        url: "../controller/scripts/owner/getfeetable.php",
                        data :  dataString,
                        success : function(result)
                        {
                            $("#loadfeetable").html('Load');
        ...
        $("#loadothertable").click(function(){
                ...
                else
                {
                    ...
                    $.ajax({
                        type : 'post',
                        url: "../controller/scripts/owner/getothertable.php",
                        data :  dataString,
                        success : function(result)
                        {
                            $("#loadothertable").html('Load');
        ...
        $("body").on("click", "#deleteloadincomefeetransbtn", function(){
            ...
            $.ajax({
                type : 'post',
                url : '../controller/scripts/owner/loaddelincomefeetransbody.php', //Here you will fetch records 
        ...
        $("body").on("click", "#deleteincomefeetransmainbtn", function(){
            ...
            var category = $('#feecatid').val();
            var subcategory = $('#feesubcatid').val();
            var studid = $('#feestudid').val();
            var session = $('#feesessionname').val();
            var date = $('#feedate').val();
            var term = $('#feeterm').val();
            var time = $('#feetime').val();
            var classid = $('#feeclass').val();
            var depositorOrReciepientName = $('#feedepositorOrReciepientName').val();
            ...
            // alert(dataString);
             $.ajax({
                type : 'post',
                url : '../controller/scripts/owner/proceeddelincomefeetransbody.php', //Here you will fetch records 
                data : dataString, //Pass $id
                success : function(data){
        ...
        $("body").on("click", "#deleteloadincomeothertransbtn", function(){
            ...
            $.ajax({
                type : 'post',
                url : '../controller/scripts/owner/loaddelincomeothertransbody.php', //Here you will fetch records 
                data : dataString, //Pass $id
                success : function(data){
        ...
        $("body").on("click", "#deleteincomeothertransmainbtn", function(){
            ...
            // alert(dataString);
             $.ajax({
                type : 'post',
                url : '../controller/scripts/owner/proceeddelincomeothertransbody.php', //Here you will fetch records 
                data : dataString, //Pass $id
                success : function(data){
