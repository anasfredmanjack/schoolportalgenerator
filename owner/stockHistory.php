...
<head>
    <meta charset="utf-8">
        ...
        <title>Stock History | <?php echo $fullname; ?></title>
        <!-- Bootstrap Core CSS -->
        ...
        <div class="page-wrapper" >
            ...
            <div class="row page-titles no_print">
                <div class="col-sm-7 align-self-center">
                    <h2 class="text-themecolor" style="color: black; font-weight: 400;">Stock Items</h2>
                </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="button-group no_print" id="PrintBtn" style="float: right;"><button onclick="window.print()" id="addStockItemsModalBtn" type="button" class="btn btn-primary"><span class="fa fa-print"></span> Print</button></div>

                                <h4 class="card-title" style="color: red;">Stock Inventory</h4>
                                <h6 class="card-subtitle">Full list of Stock Items in all Institution/Schools</h6>
            ...
            <!-- ============================================================== -->
             <!-- .right-sidebar -->
               <!---=================Right sidebar=======================-->
               <div class="right-sidebar no_print">
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $("#loadStudinSchl").click(function(){
                ...
                var dataString = 'inst=' + inst + '&ownerid=' + ownerid;
                ...
                else 
                {
                    ...
                    if(inst != '0')
                    {
                        $.ajax({
                            type : 'post',
                            url : '../controller/scripts/owner/loadStockHistoryForSchoolPerTerm.php', //Here you will fetch records
                        ...
                        $.ajax({
                            type : 'post',
                            url : '../controller/scripts/owner/loadTotalNumberStockItemsForSchoolPerTerm.php', //Here you will fetch records
                            data :  dataString, //Pass $id
                            success : function(data){
                        ...
                        $.ajax({
                            type : 'post',
                            url : '../controller/scripts/owner/loadTotalNumberStockItemsForSchoolPerTerm2.php', //Here you will fetch records
                            data :  dataString, //Pass $id
                            success : function(data){
                        ...
                        $.ajax({
                            type : 'post',
                            url : '../controller/scripts/owner/loadTotalNumberStockItemsForSchoolPerTerm3.php', //Here you will fetch records
                            data :  dataString, //Pass $id
                            success : function(data){
