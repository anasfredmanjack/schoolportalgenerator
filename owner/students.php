                        ...
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                        <div class="card">
                                            <div align="Center" class="card-body analytics-info">
                                                ...
                                                <span class="text-right">
                                                    <span style="color: black; font-size: 14px; font-weight: 600;">Total No. of Students<br>(Paid School Fees)</span>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                        <div class="card">
                                            <div align="Center" class="card-body analytics-info">
                                                ...
                                                <span class="text-right">
                                                    <span style="color: black; font-size: 14px; font-weight: 600;">Total No. of Students<br>(Unpaid School Fees)</span>
                                                    <i class="ti-arrow-up text-danger"></i> 
                                                    <span class="counter text-danger"></span>
                                                </span>
                                                <p></p>
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="table m-t-30 table-hover no-wrap contact-list table-striped" style="font-size: 15px;">                                        
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="font-weight: 700;">School Fees</th>
    ...
    <script>
        ...
        $("#loadStudinSchl").click(function(){
            ...
            if(inst == '0' || inst == "")
            {
                ...
                $('#table-Data').html('<tr><td style="color: #FF2B2B" align="center" colspan="12"> Please Select Institution </td></tr>');
            ...
            else
            {
                ...
                if(inst != '0' && sunnygrade == '0' && sunnyclass == '0' && sunnysession == '0')
                {
                    $.ajax({
                    type : 'post',
                    url : '../controller/scripts/owner/loadAllStudforSchl.php', //Here you will fetch records
                    ...
                    $.ajax({
                        type : 'post',
                        url : '../controller/scripts/owner/loadtotnumStudforSchl.php', //Here you will fetch records
                        data :  dataString, //Pass $id
                        success : function(data){
                ...
                else
                {
                    if(inst != '0' && sunnysession != '0' && sunnygrade == '0' && sunnyclass == '0')
                    {
                        $.ajax({
                        type : 'post',
                        url : '../controller/scripts/owner/loadStudforSchlpersession.php', //Here you will fetch records
                        data :  dataString, //Pass $id
                        success : function(data){
                            $('#table-Data').html(data);//Show fetched data from database
                            $('#loadStudinSchl').html('Load');
                        ...
                        $.ajax({
                            type : 'post',
                            url : '../controller/scripts/owner/loadtotnumStudforSchlpersession.php', //Here you will fetch records
                            data :  dataString, //Pass $id
                            success : function(data){
                                $('#totnumStud').html(data);//Show fetched data from database
                                $('#totnumStud2').html(data);
                    ...
                    else
                    {
                        if(inst != '0' && sunnysession != '0' && sunnygrade != '0' && sunnyclass == '0')
                        {
                            $.ajax({
                            type : 'post',
                            url : '../controller/scripts/owner/loadStudforSchlpergrade.php', //Here you will fetch records
                            data :  dataString, //Pass $id
                            success : function(data){
                                $('#table-Data').html(data);//Show fetched data from database
                                $('#loadStudinSchl').html('Load');
                            ...
                            $.ajax({
                                type : 'post',
                                url : '../controller/scripts/owner/loadtotnumStudforSchlpergrade.php', //Here you will fetch records
                                data :  dataString, //Pass $id
                                success : function(data){
                                    $('#totnumStud').html(data);//Show fetched data from database
                                    $('#totnumStud2').html(data);
                        ...
                        else
                        {
                            if(inst != '0' && sunnysession != '0' && sunnygrade != '0' && sunnyclass != '0')
                            {
                                $.ajax({
                                    type : 'post',
                                    url : '../controller/scripts/owner/loadStudforSchlperclass.php', //Here you will fetch records
                                    data :  dataString, //Pass $id
                                    success : function(data){
                                        $('#table-Data').html(data);//Show fetched data from database
                                        $('#loadStudinSchl').html('Load');
                                ...
                                $.ajax({
                                    type : 'post',
                                    url : '../controller/scripts/owner/loadtotnumStudforSchlperclass.php', //Here you will fetch records
                                    data :  dataString, //Pass $id
                                    success : function(data){
                                        $('#totnumStud').html(data);//Show fetched data from database
                                        $('#totnumStud2').html(data);
